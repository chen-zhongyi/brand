...
@RestController
@RequestMapping( value = "/api/bzrz2s")
@Api( value = "api --- ApproveBzrz2Controller", description = "企业行业认证")
public class ApproveBzrz2Controller extends BaseController{

    @Autowired
    private ApproveBzrz2Service bzrzService;
    ...
    public Map<String, Object> insert(@ApiIgnore HttpServletRequest httpRequest, @RequestBody @Valid ApproveBzrzRequest request, @ApiIgnore Errors errors) {
        ...
        ApproveBzrz2 bzrz = new ApproveBzrz2();
